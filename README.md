...
На практике `medium` на CPU даёт хорошую скорость для большинства задач. Если нужна максимальная производительность на AMD — потребуется собирать ctranslate2 с ROCm-бэкендом вручную (выходит за рамки этого проекта).
